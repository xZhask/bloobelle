...
-- Tiempo de generación: 05-06-2026 a las 13:20:32
...
--
-- Base de datos: `may11odin1026d_bloobelle`
--
...
(18, 'Frasco liso 10 ml', 'generico', 10, '/assets/images/frascos/frasco_6a1e0fc6b0871.webp', 'Frasco liso de 10 ml', 1, 1, 1);
...
(1, 1, 2, 'Alcohol', 10.00, '2026-06-02 20:25:53'),
(2, 1, 2, 'Cartulina', 5.00, '2026-06-02 23:09:52'),
(3, 1, 2, 'Alcohol', 10.00, '2026-06-04 13:39:54');
...
(1, 1, 18, 'entrada', 50, 'Entrada de stock', 1, NULL, '2026-06-01 18:03:53'),
(2, 1, 1, 'entrada', 10, 'Entrada de stock', 1, NULL, '2026-06-01 18:23:35'),
(3, 1, 2, 'entrada', 10, 'Entrada de stock', 1, NULL, '2026-06-01 18:23:46'),
(4, 1, 3, 'entrada', 5, 'Entrada de stock', 1, NULL, '2026-06-01 18:23:56'),
(5, 1, 1, 'venta', -1, 'Venta POS', 1, 1, '2026-06-01 18:27:02'),
(6, 1, 18, 'venta', -1, 'Venta POS', 1, 1, '2026-06-01 18:27:02'),
(7, 1, 3, 'venta', -1, 'Venta POS', 1, 2, '2026-06-01 18:27:51'),
(8, 1, 1, 'venta', -1, 'Venta POS', 1, 3, '2026-06-01 18:28:57'),
(9, 1, 1, 'venta', -1, 'Venta POS', 1, 3, '2026-06-01 18:28:57'),
(10, 1, 18, 'venta', -1, 'Venta POS', 1, 4, '2026-06-01 20:29:00'),
(11, 1, 2, 'venta', -2, 'Venta POS', 1, 5, '2026-06-01 21:31:01'),
(12, 1, 18, 'venta', -1, 'Venta POS', 1, 5, '2026-06-01 21:31:01'),
(13, 1, 18, 'entrada', 50, 'Entrada de stock', 1, NULL, '2026-06-01 21:36:33'),
(14, 1, 9, 'entrada', 1, 'Entrada de stock', 1, NULL, '2026-06-01 21:37:10'),
(15, 1, 2, 'venta', -1, 'Venta POS', 2, 6, '2026-06-01 21:40:41'),
(16, 1, 1, 'venta', -1, 'Venta POS', 2, 7, '2026-06-02 20:23:02'),
(17, 1, 18, 'venta', -1, 'Venta POS', 2, 8, '2026-06-02 20:24:18'),
(18, 1, 1, 'venta', -1, 'Venta POS', 2, 8, '2026-06-02 20:24:18'),
(19, 1, 2, 'venta', -1, 'Venta POS', 2, 9, '2026-06-04 13:27:11'),
(20, 1, 1, 'venta', -1, 'Venta POS', 2, 10, '2026-06-04 13:27:42'),
(21, 1, 1, 'venta', -1, 'Venta POS', 2, 11, '2026-06-04 18:17:21'),
(22, 1, 1, 'venta', -1, 'Venta POS', 2, 12, '2026-06-04 18:17:57'),
(23, 1, 18, 'venta', -1, 'Venta POS', 2, 13, '2026-06-04 18:18:40'),
(24, 1, 18, 'venta', -1, 'Venta POS', 2, 14, '2026-06-04 18:19:15'),
(25, 1, 1, 'venta', -1, 'Venta POS', 2, 15, '2026-06-04 20:01:00'),
(26, 1, 18, 'venta', -1, 'Venta POS', 2, 16, '2026-06-04 20:01:33');
...
(66, 'DD001', '212 NYC', '/assets/images/perfumes/perfume_6a1e711bc1cfc.webp', 'Un perfume floral y urbano con notas de azahar, camelia y gardenia sobre un fondo de sándalo.', 2, 1),
...
(124, 'DD908', 'BORN IN ROMA INTENSE', '/assets/images/perfumes/perfume_6a1f9c30a22c2.webp', 'Fragancia floral ambarina con jazmín y vainilla bourbon para una noche inolvidable.', 2, 22),
(125, 'DD909', 'VANILLA LACE', NULL, 'Aroma clásico de vainilla pura y orquídea, cálido y reconfortante.', 2, 48),
(126, 'DD911', 'DAZZLE', '/assets/images/perfumes/perfume_6a1e7da14d1ea.webp', 'Perfume brillante de Paris Hilton con cereza ácida, manzana roja y orquídea.', 2, 30),
(127, 'DD912', 'MISS DIOR BLOOMING', '/assets/images/perfumes/perfume_6a1e7d0c11003.webp', 'Bouquet floral delicado con peonía, rosa damascena y almizcle blanco.', 2, 17),
(128, 'DD913', 'DIVINE', '/assets/images/perfumes/perfume_6a1e79af3a2a3.webp', 'Fragancia floral marina de Jean Paul Gaultier con notas solares y lirio blanco.', 2, 11),
(129, 'DD914', 'ISLAND BLISS', '/assets/images/perfumes/perfume_6a1e7c20d0b4b.webp', 'Aroma tropical que evoca vacaciones con coco, frutas exóticas y flores blancas.', 2, 19),
(130, 'DD916', 'YUM YUM', '/assets/images/perfumes/perfume_6a1e689009931.webp', 'Fragancia divertida y golosa con notas de frutas dulces y un fondo de vainilla.', 2, 19),
(131, 'DD917', 'HYPNOTIC POISON', '/assets/images/perfumes/perfume_6a1e7a91b2d41.webp', 'Esencia magnética de Dior con almendra amarga, jazmín sambac y vainilla.', 2, 17),
(132, 'DD918', 'THANK U NEXT', '/assets/images/perfumes/perfume_6a1e75f26b951.webp', 'Perfume audaz con pera blanca, frambuesa silvestre y coco cremoso.', 2, 42),
(133, 'DD919', 'LA BOMBA', '/assets/images/perfumes/perfume_6a1e7b6586838.webp', 'Aroma explosivo y floral con notas de jazmín, rosa y un fondo dulce amaderado.', 2, 1),
(134, 'DD920', 'SI', '/assets/images/perfumes/perfume_6a1e720f00e77.webp', 'Fragancia elegante de Giorgio Armani con néctar de grosella negra y maderas claras.', 2, 2),
(135, 'DD921', 'RICCI RICCI', '/assets/images/perfumes/perfume_6a1e6994a1e5d.webp', 'Aroma chic con notas de ruibarbo, bergamota y flor de dondiego de noche.', 2, 49),
(136, 'DD922', 'SCANDAL BY NIGHT', '/assets/images/perfumes/perfume_6a1e788db68a8.webp', 'Una versión más profunda y amielada del original, con nardos y haba tonka.', 2, 11),
...
(138, 'XS001', 'PURE SEDUCTION', '/assets/images/perfumes/perfume_6a1e63d3d1909.webp', 'Fragancia frutal clásica de Victoria\'s Secret con ciruela roja y freesia.', 2, 48),
(139, 'XS003', 'COCONUT PASSION', '/assets/images/perfumes/perfume_6a1e6ec8efc7f.webp', 'Aroma cálido y tropical que mezcla coco, vainilla y lirio de los valles.', 2, 48),
(140, 'XS009', 'WILD MADAGASCAR', '/assets/images/perfumes/perfume_6a1e6e92895c8.webp', 'Fragancia exótica con notas de vainilla de Madagascar, pera y flores blancas.', 2, 51),
(141, 'CC908', 'CHERRY (LOST CHERRY)', '/assets/images/perfumes/perfume_6a1e6d907b295.webp', 'Viaje prohibido por los sentidos con cereza exótica, licor y almendra amarga.', 3, 26),
(142, 'CC911', 'MILLESIME IMPERIAL', '/assets/images/perfumes/perfume_6a1e6e5978fc2.webp', 'Fragancia real que evoca jardines cítricos y paisajes costeros con notas salinas.', 3, 27),
(143, 'CC917', 'KHAMRAH QHAWA', '/assets/images/perfumes/perfume_6a1e6d1edc615.webp', 'Versión de Khamrah con una nota intensa de café arábica, canela y dátiles dulces.', 3, 20),
(144, 'DD915', 'KIRKE', '/assets/images/perfumes/perfume_6a1e700f29c36.webp', 'Extracto de perfume mágico con maracuyá, durazno y un fondo de almizcle blanco.', 3, 52),
(145, 'UU003', 'BACCARAT ROUGE 540', '/assets/images/perfumes/perfume_6a1e6d6249f09.webp', 'Alquimia poética de jazmín, azafrán, ámbar gris y resina de abeto.', 3, 53),
(146, 'UU012', 'KHAMRAH', '/assets/images/perfumes/perfume_6a1e650447736.webp', 'Aroma opulento con dátiles, canela, vainilla y notas amaderadas de sándalo.', 3, 20),
(147, 'UU019', 'ERBA PURA', '/assets/images/perfumes/perfume_6a1e6e45d4530.webp', 'Una cesta de frutas cítricas sicilianas y mediterráneas con un fondo de ámbar y almizcle.', 3, 54),
(148, 'UU022', 'HONOR & GLORY', '/assets/images/perfumes/perfume_6a1e6d4ba122d.webp', 'Fragancia prestigiosa con piña, especias orientales y un fondo de maderas ricas.', 3, 20),
(149, 'UU023', 'SUBLIME', '/assets/images/perfumes/perfume_6a1e643c2c3b3.webp', 'Aroma sofisticado que mezcla notas florales y frutales con una elegancia atemporal.', 3, 20),
(150, 'CC919', 'PEGASUS', '/assets/images/perfumes/perfume_6a1e6f4f840ea.webp', 'Fragancia oriental elegante con almendra, vainilla y sándalo; cremosa, sofisticada y de alta duración.', 1, 55),
(151, 'UU020', 'BLEECKER STREET', '/assets/images/perfumes/perfume_6a1e660fe48b3.webp', 'Aroma fresco amaderado con notas verdes, arándanos y pachulí; moderno y distintivo.', 3, 56),
(152, 'CC137', 'TOY BOY', '/assets/images/perfumes/perfume_6a1e6b81a151d.webp', 'Perfume especiado y floral con rosa, pimienta y vetiver; masculino, moderno y atrevido.', 1, 43),
(153, 'DD147', 'DELINA', '/assets/images/perfumes/perfume_6a1e674e69b65.webp', 'Fragancia floral frutal con rosa turca, lichi y vainilla; femenina, elegante y envolvente.', 2, 55),
(154, 'DD925', 'MALLOW MADNESS', '/assets/images/perfumes/perfume_6a1e6c7e615f3.webp', 'Aroma gourmand dulce con malvavisco, vainilla y notas cremosas; cálido y adictivo.', 2, 20),
(155, 'DD926', 'MOD VANILLA', '/assets/images/perfumes/perfume_6a1e6a3c4e01d.webp', 'Perfume suave y moderno con vainilla, cacao y almizcle; dulce, limpio y reconfortante.', 2, 42);
...
(1, 1, 1, '2026-06-01 18:27:02', 45.00, 'efectivo', NULL),
(2, 1, 1, '2026-06-01 18:27:51', 80.00, 'yape_plin', NULL),
(3, 1, 1, '2026-06-01 18:28:57', 50.00, 'efectivo', NULL),
(4, 1, 1, '2026-06-01 20:29:00', 15.00, 'yape_plin', NULL),
(5, 1, 1, '2026-06-01 21:31:01', 100.00, 'efectivo', NULL),
(6, 1, 2, '2026-06-01 21:40:41', 45.00, 'efectivo', NULL),
(7, 1, 2, '2026-06-02 20:23:02', 30.00, 'efectivo', NULL),
(8, 1, 2, '2026-06-02 20:24:18', 45.00, 'yape_plin', NULL),
(9, 1, 2, '2026-06-04 13:27:11', 45.00, 'yape_plin', NULL),
(10, 1, 2, '2026-06-04 13:27:42', 30.00, 'efectivo', NULL),
(11, 1, 2, '2026-06-04 18:17:21', 30.00, 'yape_plin', NULL),
(12, 1, 2, '2026-06-04 18:17:57', 30.00, 'efectivo', NULL),
(13, 1, 2, '2026-06-04 18:18:40', 15.00, 'yape_plin', NULL),
(14, 1, 2, '2026-06-04 18:19:15', 15.00, 'yape_plin', NULL),
(15, 1, 2, '2026-06-04 20:01:00', 30.00, 'efectivo', NULL),
(16, 1, 2, '2026-06-04 20:01:33', 15.00, 'efectivo', NULL);
